...
public class ModelAnimeList2 {
    private String id,animeName,seasonsAnime,year,typeAnime,rating,sampul,airedAnime,uid;
    long timestamp;

    public ModelAnimeList2(String id, String animeName, String seasonsAnime, String year, String typeAnime, String rating, String sampul, String airedAnime, String uid, long timestamp) {
        this.id = id;
