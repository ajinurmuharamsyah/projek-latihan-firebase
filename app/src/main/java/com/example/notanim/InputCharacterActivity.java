...
public class InputCharacterActivity extends AppCompatActivity {
    private TextView judulAnimeTv,genderTv;
    private EditText nameTv,ageTv;
    private AutoCompleteTextView monthTv,dayTv;
    ...
    private ArrayAdapter<String> modeldate,modelmonth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadGender();
//
//        modelmonth = new ArrayAdapter<String>(this,R.layout.list_item,Month);
//        monthTv.setAdapter(modelmonth);
//
//        modeldate = new ArrayAdapter<String>(this,R.layout.list_item,Date);
//        dayTv.setAdapter(modeldate);
    ...
    public void onBackPressed() {
        startActivity(new Intent(InputCharacterActivity.this,MainActivity.class));
        finish();
    }
    ...
    private void uploadImage(Uri image_uri) {
        ...
        //show progress
        progressDialog.setMessage("Uploading Character Image");
        progressDialog.show();
                ...
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        handler.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(InputCharacterActivity.this, "upload", Toast.LENGTH_SHORT).show();
                            }
                        },500);
                        ...
                        uploadCharacter(uploadedImageUrl);
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(InputCharacterActivity.this, "Failed uploding "+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });

//        //image path and name, use uid to replace previous
//        String filePathAndName = "Character/"+mAuth.getUid();
//
//        //storage reference
...
//                Toast.makeText(InputCharacterActivity.this, "Failed to upload image due to "+e.getMessage(), Toast.LENGTH_SHORT).show();
//            }
//        });
    }

    private void uploadCharacter(String uploadedImageUrl) {
        Log.d(TAG, "uploadCharacter: Upload character info");
        progressDialog.setMessage("Upload character info...");
        progressDialog.show();
        ...
        reference.child(""+timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(InputCharacterActivity.this, "Info Character Uploaded...", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(InputCharacterActivity.this, "Failed to upload db due to "+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
                ...
                .setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (which == 0){
                            ...
                            Toast.makeText(InputCharacterActivity.this, "Failed upload image", Toast.LENGTH_SHORT).show();
                        }
