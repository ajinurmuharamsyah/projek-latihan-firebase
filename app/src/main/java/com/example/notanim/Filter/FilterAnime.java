...
public class FilterAnime extends Filter {
    private ArrayList<ModelAnimeList> filterList;
    private AdapterAnimeList adapterAnimeList;

    public FilterAnime(ArrayList<ModelAnimeList> filterList, AdapterAnimeList adapterAnimeList) {
    ...
    protected FilterResults performFiltering(CharSequence constraint) {
        ...
        if (constraint !=null && constraint.length()>0){
            ...
            ArrayList<ModelAnimeList> filteredModels = new ArrayList<>();
    ...
    protected void publishResults(CharSequence constraint, FilterResults results) {
        adapterAnimeList.animeListArrayList = (ArrayList<ModelAnimeList>) results.values;
        //refersh adapter
