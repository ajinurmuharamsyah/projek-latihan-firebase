...
public class InputAnimeActivity extends AppCompatActivity {
...
//        validateData();
    ...
    public void onBackPressed() {
        startActivity(new Intent(InputAnimeActivity.this,MainActivity.class));
        finish();
    }
    ...
    private String Anime,Rating,Year;
    ...
    private void uploadImage() {
        ...
        //show progress
        progressDialog.setMessage("Upload Anime Image");
        progressDialog.show();
        ...
        strTask = reference.putFile(image_uri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        handler.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(InputAnimeActivity.this, "upload", Toast.LENGTH_SHORT).show();
                            }
                        },500);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(InputAnimeActivity.this, "Failed uploding "+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
...
//        });
    ...
    private void uploadAnime(String uploadedImageUrl) {
        Log.d(TAG, "updateProfil: Upload anime info");
        progressDialog.setMessage("Upload Anime Info...");
        progressDialog.show();
        ...
        reference.child(""+timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(InputAnimeActivity.this, "Info Anime Uploaded...", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(InputAnimeActivity.this, "Failed to upload db due to "+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
                ...
                .setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (which == 0){
                            ...
                            Toast.makeText(InputAnimeActivity.this, "Failed upload image", Toast.LENGTH_SHORT).show();
                        }
